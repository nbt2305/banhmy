        ...
        <div class="col-md-10">
            <div class="admin-right">
                ...
                <div class="admin-right-body">
                    <!--Product row 1-->
                    <h2 style="color: green; font-size: 30px; font-weight: bold">Quản lý Admin</h2>
                    ...
                    <div class="table-wrapper">
                        <table class="fl-table">
                            ...
                            <tbody>
                                <c:forEach items="${requestScope.getListAdmins}" var="i">
                                    <c:if test="${i.getAccountName() != sessionScope.admin.getAccountName()}">
                                        <tr>
