        ...
        <div class="col-md-10">
            <div class="admin-right">
                ...
                <div class="admin-right-body">
                    <!--Product row 1-->
                    <h2 style="color: green; font-size: 30px; font-weight: bold">Quản lý người dùng</h2>
                    ...
                    <div class="table-wrapper">
                        <table class="fl-table">
                            ...
                            <tbody>
                                <c:forEach items="${requestScope.listUsers}" var="i">
                                    <tr>
                                        <td>${i.getAccountName()}</td>
                                        <td>${i.getName()}</td>
                                        <td>${i.getEmail()}</td>
                                        <td>${i.getPhone()}</td>
                                        <td><a style="background-color: green;padding: 5px;color: white; text-decoration: none" href="upUserToAdmin?AccountName=${i.getAccountName()}">Cấp quyền admin</a>&nbsp; &nbsp;<a style="background-color: red;padding: 5px;color: white; text-decoration: none" href="removeUser?AccountName=${i.getAccountName()}">Khóa</a></td>
                                    </tr>
                                </c:forEach>
                            <tbody>
                        </table>
                    ...
                    <!-- Tai khoan sau khi bi khoa -->
                    <h2 style="color: green; font-size: 30px; font-weight: bold">Tài khoản bị khóa</h2>
                    <!--<h3 style="color: green; font-size: 20px; text-align: center">${requestScope.bell}</h3>-->
                    <div class="table-wrapper">
                        <table class="fl-table">
                            <thead>
                            ...
                            <tbody>
                                <c:forEach items="${requestScope.listUserLock}" var="i">
                                    <tr>
                                        <td>${i.getAccountName()}</td>
                                        <td>${i.getName()}</td>
                                        <td>${i.getEmail()}</td>
                                        <td>${i.getPhone()}</td>
                                        <td><a style="background: blue;padding: 5px;color: white; text-decoration: none" href="restoreUser?AccountName=${i.getAccountName()}">Khôi phục</a></td>
                                    </tr>
                                </c:forEach>
                            <tbody>
                        </table>
