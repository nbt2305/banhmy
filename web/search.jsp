<%-- 
    Document   : search
    Created on : Oct 24, 2022, 3:40:50 AM
    Author     : ADMIN
--%>
    ...
    <div class="location">
        <div class="location-content">
            <div class="location-link">
                <a href="home">Trang chủ</a> / <a style="color: black;" href="">Tìm kiếm</a>
            </div>
      ...
      <!--Form dang nhap-->
      <div class="background-form-login">
        <div class="form-login">
          <h4>Đăng nhập</h4>
          <div onclick="closeLogIn()" class="icon-close">
      ...
      <!--Form dang ky-->
      <div class="background-form-signup">
        <div class="form-signup">
          <h4>Đăng ký</h4>
          <div onclick="closeSignUp()" class="icon-close">
            <i class="fa-sharp fa-solid fa-xmark"></i>
          </div>
          <div class="user">
            <i class="fa-solid fa-user"></i>
