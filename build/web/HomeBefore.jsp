    ...
    <div class="header">
        <div class="row header-content">
            ...
            <div class="col-md-2 header-login">
                <div style="margin-right: 30px" class="sign-up">
            ...
            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
              ...
              <li class="nav-item dropdown">
                ...
                <ul style="background-color: #fcba03;" class="dropdown-menu" aria-labelledby="navbarDropdown">
                    <c:forEach items="${sessionScope.listCategories}" var="i">
                        <li><a class="dropdown-item" href="#">${i.getCategoryName()}</a></li>
                    </c:forEach>
                </ul>
              </li>
              <li class="nav-item">
            ...
            <div style="margin-bottom:50px;" class="col-md-4 product-cards-details">
              <div class="card" style="width: 100%;">
                ...
                <div class="card-body">
                  ...
                  <a href="#" class="product-buy">Mua hàng</a>
                </div>
              </div>
            </div>
          </c:forEach>
